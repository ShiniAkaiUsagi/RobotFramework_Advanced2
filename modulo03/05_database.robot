*** Settings ***
Documentation   [14/10/2019] https://franz-see.github.io/Robotframework-Database-Library/api/1.2.2/Database.html
...             Instale: "pip install -U robotframework-Database"
...
Exemplo 01: Executando scripts SQL via Arquivos
    Executar script via ARQUIVO no Banco de Dados       ${CURDIR}/Database/my_sql_scripts/create_table_accounts.sql
    Executar script via ARQUIVO no Banco de Dados       ${CURDIR}/Database/my_sql_scripts/insert_into_account.sql
